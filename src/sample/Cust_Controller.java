...
//LOGICAL DELETE. isDeleted set to 1 to HIDE
            ...
            preparedStmt.setString(1, addcustID.getText());
    ...
    private void updateTable (ActionEvent event) {
        ...
        try {
            ...
            preparedStmt.setString(8, addcustID.getText());
    ...
    private void viewtablex(ActionEvent event) {
        ...
        try {
            ...
            String SQL2 = "SELECT CustLocation_ID, Customer_ID, StreetAddress, BillingAddress,PostalCode_ID, City, StateProvince_ID, Country_ID FROM CustLocation WHERE IsDeleted=0";
            ...
            while (jrs2.next() & jrs.next() & jrs3.next() & jrs4.next() & jrs5.next()) {
                data.add(new CustomerDetails(jrs2.getString("CustLocation_ID"),jrs2.getString("Customer_ID"),jrs2.getString("StreetAddress"),jrs2.getString("BillingAddress"),jrs2.getString("PostalCode_ID"),
                        jrs2.getString("City"),jrs2.getString("StateProvince_ID"), jrs2.getString("Country_ID"),
                        ...
                        jrs.getString("CustomerType_ID"),  jrs4.getString("PostalCode"),jrs5.getString("StateProvinceName"),jrs3.getString("CountryName")));
    ...
    private void setCellValueFromTableToTextField() {
        ...
        tableCustomer.setOnMouseClicked(new EventHandler<javafx.scene.input.MouseEvent>() {
            ...
            public void handle(javafx.scene.input.MouseEvent event) {
                ...
                addFirstName.setText(pl.getFirstName());
                addLastName.setText(pl.getLastName());
                addOrg.setText(pl.getOrganization());
                addEmail.setText(pl.getEmail());
                addPhone.setText(pl.getPhone());
                custLocID.setText(pl.getCustLocation_ID());
                addStreet.setText(pl.getStreetAddress());
                addBill.setText(pl.getBillingAddress());
                addCityz.setText(pl.getCity());
